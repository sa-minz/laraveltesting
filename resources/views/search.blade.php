...
<div class="container my-5">
  <h1 class="mb-4 text-primary text-center">Search for Medicines</h1>
  <form class="d-flex mb-4" action="{{ url('/search-results') }}" method="GET">
    <input
      class="form-control me-2"
      type="search"
      placeholder="Enter medicine name, type, or details"
      aria-label="Search"
      name="query"
      required
    />
  ...
  <div class="text-center">
    <p>Enter your search query above and press "Search".</p>
  </div>
</div>
